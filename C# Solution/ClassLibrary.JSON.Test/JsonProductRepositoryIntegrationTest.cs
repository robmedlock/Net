...
namespace ClassLibrary.JSON.Test
{
    public class JsonProductRepositoryIntegrationTest
    {
        ...
        public void JsonSerializationTest()
        {
            ...
            JsonProductRepository productRepository = new JsonProductRepository(new JsonProductSerializer(path));
            ...
            productRepository = new JsonProductRepository(new JsonProductSerializer(path));
            //assert
